...
(async () => {
  ...
  await page.goto('https://ecoleversity.com/fr/dashboard/teacher/overview', { waitUntil: 'networkidle', timeout: 60000 });
  await page.waitForTimeout(2000);
  await page.screenshot({ path: 'C:\\Ecoleversity\\scripts\\teacher-overview.png', fullPage: false });
  console.log('Teacher overview screenshot saved');
