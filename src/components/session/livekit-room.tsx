...
// Reverted from tldraw experiment back to the in-house custom canvas
// after live-test instability. The custom whiteboard has known
// limitations (no shapes, no rich text) but it renders deterministically
// and survives close+reopen via items refs. Re-evaluate tldraw or
// excalidraw later in a controlled test.
  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        {/* Whiteboard overlay (z-30). Always mounted with display:none
            when closed so strokes survive close+reopen — itemsRef is
            local and would reset on full unmount. */}
        <div
