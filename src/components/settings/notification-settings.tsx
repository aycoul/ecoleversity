      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6">
        ...
        <div className="mt-4 space-y-3">
          {channels.map((ch) => (
            <label
              key={ch.value}
              className="flex cursor-pointer items-center gap-3 rounded-lg border border-slate-200 p-3 transition-colors hover:bg-slate-50 has-[:checked]:border-emerald-500 has-[:checked]:bg-emerald-50"
            >
              <input
                type="radio"
            ...
            >
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors ${
                  toggle.value ? 'bg-emerald-500' : 'bg-slate-200'
                }`}
              >
                <span
        ...
        <div className="mt-4 flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="rounded-md border border-slate-300 px-3 py-1.5 text-sm shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
            />
          </div>
          <div className="flex items-center gap-2">
            <label
